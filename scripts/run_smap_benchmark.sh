#!/bin/bash
# Run LP+RP PatchTraj benchmark on the SMAP dataset.
# SMAP: 25 features, official train/test split, single entity.
# Note: SMAP test is very large (427K timesteps), use batch_size=32.
#
# Usage:
#   bash scripts/run_smap_benchmark.sh GPU_ID
#
# Example:
#   bash scripts/run_smap_benchmark.sh 3
...
RESULTS_DIR="results/smap_benchmark"
mkdir -p "$RESULTS_DIR"

echo "=========================================="
echo "SMAP LP+RP Benchmark on GPU $GPU_ID"
echo "=========================================="
...
for renderer in line_plot recurrence_plot; do
    ...
    echo ">>> Training SMAP with $renderer..."
    ...
    echo ">>> Detecting SMAP with $renderer..."
